...
![scheme](/assets/images/rc-filter/graph-01.png){: width="50%"}

Our siple circuit is composed of a:
* photoresistor;
* $$ 1 K\Omega $$ resistor, used in _pullup_ configuration.

![fritzing circuit](/assets/images/rc-filter/photoresistor-00_bb.png)
...
![serial plotter big variation](/assets/images/rc-filter/00-big-variation.png)
...
![serial monitor](/assets/images/rc-filter/serial-monitor-01.png)
...
![serial plotter noise](/assets/images/rc-filter/00-noise.png)
...
![serial plotter changes](/assets/images/rc-filter/01-big-variation.png)

![serial plotter noise](/assets/images/rc-filter/01-noise.png)
...
![serial plotter cahges](/assets/images/rc-filter/02-big-variation.png)
...
![serial plotter noise](/assets/images/rc-filter/02-noise.png)
...
![PD float Low Pass Filter patch](/assets/images/rc-filter/03-puredata-lpf.png){: width="50%"}
...
![serial plotter big chages](/assets/images/rc-filter/04-big-variation.png)

![serial plotter noise](/assets/images/rc-filter/04-noise.png)

We also tried with different values for $$ A $$ and $$ B $$: here $$ A = 0.01 $$ and $$ B = 0.99 $$, for a _filter ratio_ of $$ \frac{A}{B} = 0.\overline{01} $$

![serial plotter big chages](/assets/images/rc-filter/04bis-big-variation.png)

![serial plotter noise](/assets/images/rc-filter/04bis-noise.png)
...
![RC filter scheme](/assets/images/rc-filter/graph-03.png){: width="80%;"}
...
![RC filter graph](/assets/images/rc-filter/graph-04.png){: width="80%;"}
...
![scheme](/assets/images/rc-filter/graph-02.png){: width="80%;"}

And here's the _Fritzing_ representation:

![fritzing](/assets/images/rc-filter/photoresistor-01_bb.png)
